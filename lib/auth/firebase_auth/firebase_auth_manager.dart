    ...
    try {
      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Por favor, ingresa tus credenciales nuevamente para confirmar la eliminación de tu cuenta.')),
        );
      }
    }
  }
    ...
    try {
      ...
      if (e.code == 'requires-recent-login') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  'Necesitas reautenticación para actualizar tu correo electrónico. Ingresa tus credenciales nuevamente.')),
        );
      }
    }
  }
  ...
  Future<BaseAuthUser?> _signInOrCreateAccount(
    ...
    try {
      ...
      return userCredential == null
          ? null
          : RiskPeruFirebaseUser.fromUserCredential(userCredential);
    } on FirebaseAuthException catch (e) {
