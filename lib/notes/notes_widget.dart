                                                                      ...
                                                                      child: StreamBuilder<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return FlutterFlowDropDown<
                                                                              String>(
                                                                            controller: _model.cboExamenesValueController ??=
                                                                                FormFieldController<String>(null),
                                                                            options:
                                                                                List<String>.from(cboExamenesExamenesRecordList.map((e) => e.reference.id).toList()),
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                      child: FlutterFlowDropDown<
                                                                          bool>(
                                                                        controller: _model
                                                                            .cboResultadoValueController ??= FormFieldController<
                                                                                bool>(
                                                                            null),
                                                                        options:
                                                                            List<bool>.from([
                                                                        ...
                                                                        onChanged:
                                                                            (val) =>
                                                                                safeSetState(() => _model.cboResultadoValue = val),
                                                                        height:
                                                                            38.0,
                                                                        maxHeight:
                                                                            300.0,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: FlutterFlowDropDown<
                                                                            String>(
                                                                          controller: _model.cbodate1ValueController ??=
                                                                              FormFieldController<String>(null),
                                                                          options: <String>[],
                                                                          onChanged: (val) =>
                                                                              safeSetState(() => _model.cbodate1Value = val),
                                                                          height:
                                                                              38.0,
                                                                          maxHeight:
                                                                              300.0,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    InkWell(
                                                                        ...
                                                                        if (_model.date1 !=
                                                                          ...
                                                                          if (_model.date2 !=
                                                                            ...
                                                                            final _datePicked2Date =
                                                                                await showDatePicker(
                                                                              context: context,
                                                                              initialDate: (_model.date1 ?? DateTime.now()),
                                                                            ...
                                                                            if (_datePicked2Date !=
                                                                              ...
                                                                              safeSetState(() {
                                                                                ...
                                                                                null) {
                                                                              safeSetState(() {
                                                                                _model.datePicked2 = _model.date1;
                                                                              });
                                                                            }
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: FlutterFlowDropDown<
                                                                            String>(
                                                                          controller: _model.cbodate2ValueController ??=
                                                                              FormFieldController<String>(null),
                                                                          options: <String>[],
                                                                          onChanged: (val) =>
                                                                              safeSetState(() => _model.cbodate2Value = val),
                                                                          height:
                                                                              38.0,
                                                                          maxHeight:
                                                                              300.0,
                                                                      ...
                                                                      StreamBuilder<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          List<ExamenesRecord>
                                                                              ...
                                                                              snapshot.data!;
                                                                          final textExamenesRecord = textExamenesRecordList.isNotEmpty
                                                                              ? textExamenesRecordList.first
                                                                              : null;
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            () {
                                                                              if (listNotesItem.calificacion >= 14.0) {
                                                                                return 'Aprobado';
                                                                              } else if ((listNotesItem.calificacion <= 13.0) && (listNotesItem.calificacion >= 0.0)) {
                                                                                return 'Desaprobado';
                                                                              } else {
                                                                                return 'Pendiente';
                                                                              }
                                                                        ...
                                                                        child: StreamBuilder<
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            List<DetallesResultadosRecord>
                                                                                ...
                                                                                snapshot.data!;
                                                                            final textDetallesResultadosRecord = textDetallesResultadosRecordList.isNotEmpty
                                                                                ? textDetallesResultadosRecordList.first
                                                                                : null;
