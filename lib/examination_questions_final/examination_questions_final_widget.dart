                                                                        ...
                                                                        return Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            stream:
                                                                              ...
                                                                              queryBuilder: (usersAnswersRecord) => usersAnswersRecord.where(
                                                                                'uid_user',
                                                                ...
                                                                children: [
                                                                  ...
                                                                  LinearPercentIndicator(
                                                                    percent:
                                                                        valueOrDefault<
                                                                            double>(
                                                                      (1 - (DateTime.now().difference(DateTime.parse(widget.refResult!.fechaInicioExamen!.toString())).inMinutes.toDouble() / widget.refExamination!.tiempoLimite))
                                                                          .clamp(
                                                                              0.0,
                                                                              1.0),
                                                                      0.0,
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          builder:
                                                                              (context) {
                                                                            final listaPreguntas =
                                                                                containerPreguntasRecordList.toList();
                                                      ...
                                                      StreamBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<PreguntasRecord>
                                                              containerPreguntasRecordList =
                                                              snapshot.data!;
                                                          final containerPreguntasRecord =
                                                              containerPreguntasRecordList
                                                                      .isNotEmpty
                                                                  ? containerPreguntasRecordList
                                                                      .first
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                StreamBuilder<
                                                                  ...
                                                                  stream:
                                                                      queryRespuestaStateRecord(
                                                                    queryBuilder: (respuestaStateRecord) =>
                                                                        respuestaStateRecord
                                                                            .where(
                                                                              'uis_user',
                                                                              isEqualTo: widget.refUser?.id,
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    List<RespuestaStateRecord>
                                                                        ...
                                                                        snapshot
                                                                            .data!;
                                                                    final containerRespuestaStateRecord = containerRespuestaStateRecordList
                                                                            .isNotEmpty
                                                                        ? containerRespuestaStateRecordList
                                                                            .first
                                                                        : null;
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        crossAxisAlignment:
                                                                            CrossAxisAlignment.start,
                                                                        children: [
                                                                          if (containerPreguntasRecord?.enunciado != null &&
                                                                              containerPreguntasRecord?.enunciado != '')
                                                                            Padding(
                                                                              padding: EdgeInsetsDirectional.fromSTEB(0.0, 20.0, 0.0, 0.0),
                                                                              child: Text(
                                                                                                            ...
                                                                                                            try {
                                                                                                              if (containerUsersAnswersRecordList.where((e) => e.respuestaUid == listaRespuesta2Item.reference.id).toList().isNotEmpty) {
                                                                                                                ...
                                                                                                                if (containerRespuestasRecordList.where((e) => e.esCorrecta).toList().length > containerUsersAnswersRecordList.length) {
                                                                                                                  ...
                                                                                                                  _model.refRespuestaCrearMobil = UsersAnswersRecord.getDocumentFromData(
                                                                                                                      createUsersAnswersRecordData(
                                                                                                                        uidUser: widget.refResult?.estudianteRef,
                                                                                                                        uidPregunta: containerPreguntasRecord?.reference.id,
                                                                                                                        respuestaUid: listaRespuesta2Item.reference.id,
                                                                                                                  ...
                                                                                                                  firestoreBatch.update(
                                                                                                                      _model.refRespuestaCrearMobil!.reference,
                                                                                                                      createUsersAnswersRecordData(
                                                                                                                        uid: _model.refRespuestaCrearMobil?.reference.id,
                                                                                                                      ));
                                                                                                                  await Future.delayed(const Duration(milliseconds: 1000));
                                                                                                                }
                                                                                                              }
                                                            ...
                                                            children: [
                                                              Builder(
                                                                builder:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    _model.estadoExamenMobil =
                                                                        await actions
                                                                            .verificarPreguntasRespondidas(
                                                                      widget
                                                                          .refResult!
                                                                          .estudianteRef,
                                                                      widget
                                                                    ...
                                                                    if (_model
                                                                      ...
                                                                      _model.resultadoFinalBienMobil = await ResultadosRecord.getDocumentOnce(widget
                                                                          .refResult!
                                                                          .reference);

                                                                      context
                                                                          .goNamed(
                                                                        ExaminationQuestionsFrmExamenWidget
                                                                            .routeName,
                                                                        queryParameters:
                                                                            {
                                                                          'refExamination':
                                                                      ...
                                                                      if (FFAppState()
                                                                        ...
                                                                        _model.resultadoFinalBien2Mobil = await ResultadosRecord.getDocumentOnce(widget
                                                                            .refResult!
                                                                            .reference);
