...
class ListaModulesWidget extends StatefulWidget {
  const ListaModulesWidget({
    super.key,
  ...
  @override
  State<ListaModulesWidget> createState() => _ListaModulesWidgetState();
}

class _ListaModulesWidgetState extends State<ListaModulesWidget> {
  late ListaModulesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaModulesModel());
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    StreamBuilder<List<ModuleRecord>>(
