...
class CrearUpdateAnuncioWidget extends StatefulWidget {
  const CrearUpdateAnuncioWidget({
    super.key,
    this.refAnnouncements,
    required this.refCourse,
  });

  final AnnouncementsCoursesRecord? refAnnouncements;
  final CoursesRecord? refCourse;

  @override
  State<CrearUpdateAnuncioWidget> createState() =>
      _CrearUpdateAnuncioWidgetState();
}

class _CrearUpdateAnuncioWidgetState extends State<CrearUpdateAnuncioWidget> {
  late CrearUpdateAnuncioModel _model;
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (widget.refAnnouncements != null) {
                                  ...
                                  var announcementsCoursesRecordReference =
                                      AnnouncementsCoursesRecord.collection
                                          .doc();
                                  await announcementsCoursesRecordReference
                                      .set({
                                    ...createAnnouncementsCoursesRecordData(
                                      uidCourse:
                                  ...
                                  _model.refAnuncio = AnnouncementsCoursesRecord
                                      .getDocumentFromData({
                                    ...createAnnouncementsCoursesRecordData(
                                      uidCourse:
                                          widget.refCourse?.reference.id,
                                  ...
                                  }, announcementsCoursesRecordReference);

                                  await _model.refAnuncio!.reference.update(
                                      createAnnouncementsCoursesRecordData(
                                    uid: _model.refAnuncio?.reference.id,
                                  ));
                                }
