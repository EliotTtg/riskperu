...
class FromResultExaminationWidget extends StatefulWidget {
  const FromResultExaminationWidget({
    super.key,
  ...
  @override
  State<FromResultExaminationWidget> createState() =>
      _FromResultExaminationWidgetState();
}

class _FromResultExaminationWidgetState
    extends State<FromResultExaminationWidget> {
  late FromResultExaminationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FromResultExaminationModel());
                                                                ...
                                                                return Container(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                          ...
                                                                          children: [
                                                                            CircularPercentIndicator(
                                                                              percent: valueOrDefault<double>(
                                                                                functions.convertirCalificacion(valueOrDefault<double>(
                                                                                  containerDetallesResultadosRecordList.firstOrNull?.nota,
                                                                                  0.0,
                                                                                )),
                                                                                0.0,
                                                                              ),
                                                                              ...
                                                                              progressColor: valueOrDefault<Color>(
                                                                                functions.colorCalificacion(valueOrDefault<double>(
                                                                                  containerDetallesResultadosRecordList.firstOrNull?.nota,
                                                                                  0.0,
                                                                                )),
                                                                      ...
                                                                      ].divide(SizedBox(height: 20.0)).addToEnd(
                                                                              SizedBox(height: 10.0)),
                                                                    ),
                                                                  ),
                                                                );
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Stack(
                                                                          ...
                                                                          children: [
                                                                            CircularPercentIndicator(
                                                                              percent: valueOrDefault<double>(
                                                                                functions.convertirCalificacion(containerDetallesResultadosRecordList.firstOrNull!.nota),
                                                                                0.0,
                                                                              ),
                                                                              radius: 80.0,
                                                                              lineWidth: 5.0,
                                                                              ...
                                                                              animateFromLastPercent: true,
                                                                              progressColor: valueOrDefault<Color>(
                                                                                functions.colorCalificacion(containerDetallesResultadosRecordList.firstOrNull!.nota),
                                                                                FlutterFlowTheme.of(context).error,
                                                                              ),
                                                                              backgroundColor: FlutterFlowTheme.of(context).alternate,
                                                                            ),
