...
class CreateUpdatePlansWidget extends StatefulWidget {
  const CreateUpdatePlansWidget({
    super.key,
    this.refPlan,
  });

  final PlansRecord? refPlan;

  @override
  State<CreateUpdatePlansWidget> createState() =>
      _CreateUpdatePlansWidgetState();
}

class _CreateUpdatePlansWidgetState extends State<CreateUpdatePlansWidget> {
  late CreateUpdatePlansModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateUpdatePlansModel());
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            final list =
                                                _model.listDescription.toList();
                                            if (list.isEmpty) {
                                              return Center(
                                                child: Container(
                                                  height: 500.0,
                                                  child:
                                                      EmptyDescriptionWidget(),
                                                ),
                                              );
                                            }
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        FlutterFlowIconButton(
                                                          ...
                                                          onPressed: () async {
                                                            _model
                                                                .removeAtIndexFromListDescription(
                                                                    listIndex);
                                                            safeSetState(() {});
                                                          },
                                                        ),
