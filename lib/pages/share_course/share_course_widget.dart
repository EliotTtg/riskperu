...
class ShareCourseWidget extends StatefulWidget {
  const ShareCourseWidget({
    super.key,
  ...
  @override
  State<ShareCourseWidget> createState() => _ShareCourseWidgetState();
}

class _ShareCourseWidgetState extends State<ShareCourseWidget> {
  late ShareCourseModel _model;
