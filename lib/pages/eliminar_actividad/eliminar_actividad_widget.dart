...
class EliminarActividadWidget extends StatefulWidget {
  const EliminarActividadWidget({
    super.key,
    required this.refActividad,
  ...
  @override
  State<EliminarActividadWidget> createState() =>
      _EliminarActividadWidgetState();
}

class _EliminarActividadWidgetState extends State<EliminarActividadWidget> {
  late EliminarActividadModel _model;
                                  ...
                                  onPressed: () async {
                                    ...
                                    try {
                                      ...
                                      firestoreBatch.update(
                                          _model.refActionCreate!.reference,
                                          createActionsRecordData(
                                            uid: _model
