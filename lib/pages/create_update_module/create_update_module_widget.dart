...
class CreateUpdateModuleWidget extends StatefulWidget {
  const CreateUpdateModuleWidget({
    super.key,
  ...
  @override
  State<CreateUpdateModuleWidget> createState() =>
      _CreateUpdateModuleWidgetState();
}

class _CreateUpdateModuleWidgetState extends State<CreateUpdateModuleWidget> {
  late CreateUpdateModuleModel _model;
                                    ...
                                    onPressed: (_model.textController.text ==
                                        ...
                                        : () async {
                                            ...
                                            if (widget!.refModule != null) {
                                              ...
                                              var moduleRecordReference =
                                                  ModuleRecord.collection.doc();
                                              await moduleRecordReference
                                                  .set(createModuleRecordData(
                                                name:
                                                    _model.textController.text,
                                                createdDate:
                                                    getCurrentTimestamp,
                                              ...
                                              await _model.refModule!.reference
                                                  .update(
                                                      createModuleRecordData(
                                                uid: _model
                                                    .refModule?.reference.id,
                                              ));
                                            }
