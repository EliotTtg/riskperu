...
class EliminarModuloWidget extends StatefulWidget {
  const EliminarModuloWidget({
    super.key,
    this.refModule,
  ...
  @override
  State<EliminarModuloWidget> createState() => _EliminarModuloWidgetState();
}

class _EliminarModuloWidgetState extends State<EliminarModuloWidget> {
  late EliminarModuloModel _model;
