...
class EliminarSessionWidget extends StatefulWidget {
  const EliminarSessionWidget({
    super.key,
  ...
  @override
  State<EliminarSessionWidget> createState() => _EliminarSessionWidgetState();
}

class _EliminarSessionWidgetState extends State<EliminarSessionWidget> {
  late EliminarSessionModel _model;
