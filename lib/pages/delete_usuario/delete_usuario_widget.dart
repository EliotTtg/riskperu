...
class DeleteUsuarioWidget extends StatefulWidget {
  const DeleteUsuarioWidget({
    super.key,
  ...
  @override
  State<DeleteUsuarioWidget> createState() => _DeleteUsuarioWidgetState();
}

class _DeleteUsuarioWidgetState extends State<DeleteUsuarioWidget> {
  late DeleteUsuarioModel _model;
