...
import 'notes_studients_mobil_model.dart';
export 'notes_studients_mobil_model.dart';

/// spelling correct
class NotesStudientsMobilWidget extends StatefulWidget {
  const NotesStudientsMobilWidget({super.key});

  static String routeName = 'NotesStudientsMobil';
  static String routePath = 'notesStudientsMobil';

  @override
  State<NotesStudientsMobilWidget> createState() =>
      _NotesStudientsMobilWidgetState();
}

class _NotesStudientsMobilWidgetState extends State<NotesStudientsMobilWidget> {
  late NotesStudientsMobilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotesStudientsMobilModel());
