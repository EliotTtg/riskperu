...
Future<double> porcentajeCourseLinea(
  ...
  // Obtener los grupos de exámenes asociados al curso con el filtro is_demo
  ...
  double progreso =
      (totalExamenesCompletados / examenesDocs.length).clamp(0.0, 1.0);
