          ...
          children: [
            if (!kIsWeb) ...[
              Padding(
                ...
                child: ListTile(
                  title: Text(
                    'Por favor, elige desde dónde deseas cargar el archivo.',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.getFont(
                      pickerFontFamily,
            ...
            if (!kIsWeb) ...[
              const Divider(),
              createUploadMediaListTile(
                  'Abre la cámara para tomar una foto o grabar un video.',
                  MediaSource.camera),
              const Divider(),
            ],
...
bool validateFileFormat(String filePath, BuildContext context) {
  ...
  ScaffoldMessenger.of(context)
    ...
    ..showSnackBar(SnackBar(
      content: Text(
          'El formato de archivo no es válido. Por favor, sube un archivo en el formato correcto.'),
    ));
  return false;
}
