        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: CoursesUserWidget.routePath,
              requireAuth: true,
              builder: (context, params) => CoursesUserWidget(),
            ),
            FFRoute(
              name: ListaSimuladoresWidget.routeName,
              path: ListaSimuladoresWidget.routePath,
              requireAuth: true,
              builder: (context, params) => ListaSimuladoresWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: CourseDatailsWidget.routeName,
              path: CourseDatailsWidget.routePath,
              requireAuth: true,
              asyncParams: {
                'refCourses': getDoc(['Courses'], CoursesRecord.fromSnapshot),
                'refCoursesClass':
                    getDoc(['ModuleClass'], ModuleClassRecord.fromSnapshot),
                'refUser': getDoc(['users'], UsersRecord.fromSnapshot),
              },
              builder: (context, params) => CourseDatailsWidget(
                refCourses: params.getParam(
                  'refCourses',
                  ParamType.Document,
                ),
                refCoursesClass: params.getParam(
                  'refCoursesClass',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              name: AdministrationTeacherWidget.routeName,
              path: AdministrationTeacherWidget.routePath,
              requireAuth: true,
              builder: (context, params) => AdministrationTeacherWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              builder: (context, params) => CoursePriceWidget(
                refCourse: params.getParam(
                  'refCourse',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              name: LoadingCartWidget.routeName,
              path: LoadingCartWidget.routePath,
              builder: (context, params) => LoadingCartWidget(),
            ),
            FFRoute(
              name: CourseTestWidget.routeName,
              path: CourseTestWidget.routePath,
              requireAuth: true,
              asyncParams: {
                'refCourse': getDoc(['Courses'], CoursesRecord.fromSnapshot),
              },
              builder: (context, params) => CourseTestWidget(
                refCourse: params.getParam(
                  'refCourse',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              ...
              path: ExaminationQuestionsFinalWidget.routePath,
              requireAuth: true,
              asyncParams: {
                'refExamination':
              ...
              builder: (context, params) => ExaminationQuestionsFinalWidget(
            ...
            FFRoute(
              name: ExaminationQuestionsViewWidget.routeName,
              path: ExaminationQuestionsViewWidget.routePath,
              requireAuth: true,
              asyncParams: {
                'refExamination':
                    getDoc(['examenes'], ExamenesRecord.fromSnapshot),
              ...
              builder: (context, params) => ExaminationQuestionsViewWidget(
                refExamination: params.getParam(
                  'refExamination',
                  ParamType.Document,
                ),
