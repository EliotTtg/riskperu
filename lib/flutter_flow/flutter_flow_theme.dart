...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xFF3D3D3D);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF125089);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF00AC7E);
  late Color warning = const Color(0xFFE19F00);
  late Color error = const Color(0xFFD90429);
  late Color info = const Color(0xFFFFFFFF);

  late Color greenResult = const Color(0xFF00CE41);
}
